...
public class PingPongRight {
    ...
    public static class PlayPingPongThread extends Thread {
         ...
         */
        // TODO - You fill in here.
        private SimpleSemaphore mSemaphoreMine, mSemaphoreNext;

        /**
         * Constructor initializes the data member(s).
         */
        public PlayPingPongThread(String stringToPrint,
                                  SimpleSemaphore semaphoreMine,
                                  SimpleSemaphore semaphoreNext,
                                  int maxIterations) {
            // TODO - You fill in here.
            mStringToPrint     = stringToPrint;
            mSemaphoreMine     = semaphoreMine;
            mSemaphoreNext     = semaphoreNext;
        ...
        private void acquire() {
            // TODO fill in here
            mSemaphoreMine.acquireUninterruptibly();
        }
