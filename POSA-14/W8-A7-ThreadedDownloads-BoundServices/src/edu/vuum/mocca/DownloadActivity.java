    ...
    public void runService(View view) {
        ...
        case R.id.bound_sync_button:
        	...
        	AsyncTask<Uri, Void, String> task = new AsyncTask<Uri, Void, String>() {
        		...
        		protected String doInBackground(Uri... params) {
        			try {
						String imagePath = mDownloadCall.downloadImage(params[0]);						
						return imagePath;
					} catch (RemoteException e) {
						Log.e(TAG, "Error invoking downloadImage() method on remote service (sync): " + e.getMessage());
					}
        			return null;
        		}
        ...
        case R.id.bound_async_button:
        	...
        	try {
				...
				Log.e(TAG, "Error invoking downloadImage() method on remote service (async): " + e.getMessage());
			}
            break;
        }
    }
