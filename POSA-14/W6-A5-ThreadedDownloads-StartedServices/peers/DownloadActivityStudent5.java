...
// just to check local file path
//            	Toast.makeText(activity,
//            			msg.getData().getString(DownloadUtils.PATHNAME_KEY),
//            			Toast.LENGTH_SHORT).show();
            	
            	activity.displayBitmap(
            		msg.getData().getString(DownloadUtils.PATHNAME_KEY)
            	);
            }
    	}
    ...
    public void runService(View view) {
        ...
        case R.id.intent_service_button:
        	...
        	startService( 
        		DownloadIntentService.makeIntent(this, handler, this.getUrlString() )
        	);
        ...
        case R.id.thread_pool_button:
            ...
            // returned from the makeIntent() factory method.
        	startService(
        		ThreadPoolDownloadService.makeIntent(this, handler, this.getUrlString() )
        	);
