...
public class DownloadActivity extends DownloadBase {
    ...
    static class MessengerHandler extends Handler {
		...
		public void handleMessage(Message msg) {
            ...
            if (activity != null) {
            	...
            	if (filePath != null) {
                    ((DownloadBase)activity).displayBitmap(filePath);
            	}
            }
    	}
    }
    ...
    public void runService(View view) {
        ...
        case R.id.intent_service_button:
            ...
            startService(DownloadIntentService.makeIntent(getApplicationContext(),
                    handler,
                    Uri.encode(getUrlString())));
        ...
        case R.id.thread_pool_button:
            ...
            // returned from the makeIntent() factory method.
        	startService(ThreadPoolDownloadService.makeIntent(getApplicationContext(),
                    handler,
                    Uri.encode(getUrlString())));
