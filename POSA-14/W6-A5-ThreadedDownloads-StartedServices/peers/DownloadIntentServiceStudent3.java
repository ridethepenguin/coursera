...
public class DownloadIntentService extends IntentService {
    ...
    public static Intent makeIntent(Context context,
    	...
    	Intent i = DownloadUtils.makeMessengerIntent(context,
	...
	protected void onHandleIntent (Intent intent) {
        ...
        try {
            decodedUrl = URLDecoder.decode(intent.getData().toString(), "UTF-8");
        } catch (UnsupportedEncodingException e) {
            Toast.makeText(getApplicationContext(), "Failed to decode URL", Toast.LENGTH_SHORT).show();
            return;
        }
