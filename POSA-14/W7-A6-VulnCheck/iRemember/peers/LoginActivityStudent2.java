...
public class LoginActivity extends StoryActivityBase{
	...
	public static File getLoginFile (Context context) {
		return StorageUtilities.getOutputMediaFile(context, 	// Line 48
				...
				// changed this from MAX_SECURITY to StorageUtilities.SECURITY_PRIVATE, because the StorageUtilities
				// only checks for the StorageUtilities.SECURITY_PRIVATE or StorageUtilities.SECURITY_PUBLIC values wich 
				// are different from MAX_SECURITY
				// default is the insecure location used!
