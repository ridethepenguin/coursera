...
public class LoginActivity extends StoryActivityBase{
	...
	/*
	 *  Error: use of an int implies the security level could be set by passing a random 
	 *  int value although the security level is defined by only two constants.
	 * 
	 *  Solution: Use of the predefined constant StorageUtilities.SECURITY_PRIVATE instead of
	 *  Integer.MAX_VALUE. All together: Not nice but sufficient for solving this 
	 *  security issue as required.
	 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Setup the UI
		setContentView(R.layout.login_activity);	// Line 36s
